...
The following two scatterplots illustrate the relationship between response article shares `shares` and predictor average keyword (max shares) `kw_max_ave`.  Both scatterplots plot these variables and add a simple linear regression line to the graph.  
...
```{r train random forest model, eval=FALSE, cache=TRUE}
