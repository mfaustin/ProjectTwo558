...
df <- data.frame(weekday=factor(df$weekday, levels = c("Sunday", "Monday", "Tuesday", 
                                                       "Wednesday", "Thursday", 
                                                       "Friday", "Saturday")),
...
# channelData$shares <- as.factor(channelData$shares)
...
# confusionMatrix(data = channelTest$shares, 
#                 reference = factor(predict(boostedTreeFit, newdata = channelTest)))
```
