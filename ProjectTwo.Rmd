...
```{r ecdf, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
...
# Linear regression with predictors selected from measures of logworth >= 1 
# (p-value < 0.1). 
...
The second linear regression model contains main effects for all the predictors listed earlier in the correlation plot.  
...
Based on the preceding analyses with test data, the `r selectModel[2]` model yields the lowest RMSE - `r selectModel[1]`. 
