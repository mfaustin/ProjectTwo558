...
if (params$channel=="data_channel_is_entertainment") {
...
if (params$channel=="data_channel_is_socmed") {
  knitr::opts_chunk$set(fig.path = "images/socmed/")
} 
if (params$channel=="data_channel_is_tech") {
  knitr::opts_chunk$set(fig.path = "images/tech/")
} 
if (params$channel=="data_channel_is_world") {
